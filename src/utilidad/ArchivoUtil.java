...
public class ArchivoUtil {
    private static final String RUTA_ARCHIVO = "Resources/categorias.txt"; // Ruta relativa al archivo dentro del proyecto

    // Método para cargar categorías desde el archivo
    public static Categoria[] cargarCategorias() {
        Categoria[] categorias = new Categoria[5]; // Máximo de 5 categorías
